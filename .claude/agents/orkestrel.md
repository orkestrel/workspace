...
| `@orkestrel/scaffold`   | `0.0.41` | L3    | `@orkestrel/console` `^0.0.8`, `@orkestrel/contract` `^0.0.12`, `@orkestrel/emitter` `^0.0.7`, `@orkestrel/markdown` `^0.0.9`, `@orkestrel/template` `^0.0.4`                                                                                                                                                             |
